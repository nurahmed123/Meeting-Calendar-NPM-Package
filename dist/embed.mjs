...
var MeetingCalendar = (_a) => {
  var _b = _a, { username, style } = _b, props = __objRest(_b, ["username", "style"]);
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    "iframe",
    __spreadValues({
      src: `https://calendar.arionys.com/${username}`,
      style: __spreadValues({ width: "100%", height: "100vh", border: "none" }, style),
...
var MeetingCalendarEmbed = class extends HTMLElement {
  connectedCallback() {
